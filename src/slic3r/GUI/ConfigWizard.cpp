...
void PageDiameters::apply_custom_config(DynamicPrintConfig &config)
{
    ...
    config.option("extrusion_width")->set_phony(false);
    config.option("first_layer_extrusion_width")->set_phony(false);
    config.option("perimeter_extrusion_width")->set_phony(false);
    config.option("external_perimeter_extrusion_width")->set_phony(false);
    config.option("external_perimeter_extrusion_width")->set_phony(false);
    config.option("infill_extrusion_width")->set_phony(false);
    config.option("solid_infill_extrusion_width")->set_phony(false);
    config.option("top_infill_extrusion_width")->set_phony(false);
    config.update_phony({});
}
